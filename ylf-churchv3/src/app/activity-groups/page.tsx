...
const DEFAULT_GROUPS = [
  {
    ...
    name: 'Skit',
    description:
      'Creative drama ministry to communicate the Gospel through storytelling.',
    icon: '🎭',
  },
  {
    _id: '2',
    name: 'Promotion',
    description:
      'Spreading the message of YLF through creative outreach and communication.',
    icon: '📢',
  },
  {
    _id: '3',
    name: 'Open Home',
    description:
      'Intimate gatherings where connections thrive and relationships flourish.',
    icon: '🏠',
  },
  {
    _id: '4',
    name: 'Broadcasting',
    description:
      'Digital ministry — streams, records and distributes sermons and worship.',
    icon: '📺',
  },
  {
    _id: '5',
    ...
    description:
      'Crafting compelling media — graphics, videos, and written content.',
    icon: '🎨',
  },
  {
    _id: '6',
    ...
    description:
      "Writing original worship music and hymns to usher in God's presence.",
    icon: '🎵',
  },
  {
    _id: '7',
    ...
    description:
      'Organising Spirit-filled retreats for deep encounters and renewal.',
    icon: '⛺',
  },
  {
    _id: '8',
    name: 'Video Editing',
    description:
      'Post-production team crafting powerful video testimonies and content.',
    icon: '🎬',
  },
  {
    _id: '9',
    name: 'Intercession',
    description:
      'The prayer engine of YLF — standing in the gap for church, city and nations.',
    icon: '🙏',
  },
  {
    _id: '10',
    name: 'Teaching',
    description:
      'Preparing and delivering edifying lessons grounded in the Word of God.',
    icon: '📖',
  },
  {
    _id: '11',
    name: 'Worship',
    description:
      'Leading the community in Spirit-filled praise and worship to Yeshua.',
    icon: '🎤',
  },
]

export default async function ActivityGroupsPage() {
  const groups = await sanityFetch<ActivityGroup[]>(
    activityGroupsQuery,
    {},
    ['activityGroups']
  )
        ...
        >
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-white/80 leading-relaxed">
              Come and be a part of our Open-Homes where connections
              thrive and relations flourish. These intimate Zoom
              gatherings are the heartbeat of our community real
              conversations, real faith, real family.
            </p>
          </div>
