    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(to bottom,transparent 40%,rgba(61,44,92,0.6))',
          }}
        />
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <span
            ...
            style={{ color: 'var(--soft-lavender,#d6c7e3)' }}
          >
            {date}
          </span>
        </div>
        ...
        <h3
          className="font-serif font-bold text-base leading-snug mb-2 flex-1"
