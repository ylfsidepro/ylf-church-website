...
export function Navbar() {
  ...
  return (
    <nav
      ...
      style={{
        background: 'var(--deep-indigo)', // burgundy base
        ...
        <Link href="/" className="flex items-center gap-3 no-underline">
          <div
            ...
            style={{
              ...
              borderRadius: '12px',
              overflow: 'hidden',
              boxShadow: '0 4px 16px rgba(224,123,42,0.45)', // warm orange glow
            }}
          >
            <Image
          ...
          <div className="flex flex-col leading-none">
            ...
            <span
              ...
              style={{ color: 'var(--spirit-blue)' }} // warm orange accent
            >
        ...
        <ul className="hidden lg:flex items-center gap-0.5 list-none">
          ...
          <li>
            <Link
              ...
              style={{
                background:
                  'linear-gradient(135deg,var(--spirit-blue),#c25f12)',
