...
export const metadata: Metadata = {
  ...
  description: 'Discover a variety of activities hosted live on Zoom throughout the week.',
}

// Default groups used when CMS has no data yet
...
export default async function ActivityGroupsPage() {
  const groups = await sanityFetch<ActivityGroup[]>(activityGroupsQuery, {}, ['activityGroups'])
  ...
  return (
    <section className="min-h-screen pt-28 pb-20 px-6" style={{ background: 'var(--lavender-light,#f0eaf8)' }}>
      <div className="max-w-6xl mx-auto">
        ...
        {/* Open Homes Banner */}
        <div className="mt-12 rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-center gap-6 text-white shadow-xl"
          ...
          <div className="w-20 h-20 rounded-2xl flex items-center justify-center text-4xl flex-shrink-0"
            style={{ background: 'rgba(244,165,53,0.2)' }}>🏠</div>
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-white/80 leading-relaxed">
              ...
              These intimate Zoom gatherings are the heartbeat of our community — real conversations, real faith, real family.
            </p>
          </div>
          <Link href="/connect"
